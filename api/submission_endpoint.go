...
func SubmissionEndpoint() {
	log.Println("Code Submitted")
	database.UserSubmission("12345","123-A",`// Author - Parthsarthi Dutt
...
}`,"parthsarthidutt_45","cpp",600,600,"practice")
database.UserSubmission("12346","124-A",`// Author - Parthsarthi Dutt
...
int main()
{
    ...
    auto stop1 = high_resolution_clock::now();
    auto duration = duration_cast<microseconds>(stop1 - start1);
}`,"parthsarthidutt_45","cpp",600,600,"contest")
}